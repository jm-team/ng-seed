...
app.registerController('HomeCtrl', ['$scope', 'AuthService', '$http', 'Cookie', '$q', 'Public', 'SERVER_ADDRESS', 'SessionService', 'datePickService',
    function($scope, AuthService, $http, Cookie, $q, Public, SERVER_ADDRESS, SessionService, datePickService) {
  ...
  angular.extend($scope, {
    ...
    batch: function() {
      Public.Batch().save({},{
        data: [
          { "data": { name: 1 }, "method": "post", "uri":"/subTest1/1" },
          { "data": { name: 25 },"method": "get","uri":"/subTest2/2" }
        ]
      });
    }
  })
