  ...
  dev: {
    ...
    devServer: {
      ...
      proxyTarget: [
        ...
        , { pattern: '/getUploadToken', address: address.CENTER_ADDRESS }
        , { pattern: '/getFile', address: address.CENTER_ADDRESS }
        , { pattern: '/upload.do', address: address.UPLOAD_ADDRESS }
        , { pattern: '/sso', address: address.SERVER_ADDRESS }
