  ...
  */
  ...
  function fly(scope, elm, attrs, wrapWidth) {
    ...
    !!scope.preBtn ? (function() {
      $preBtn = angular.element(document.getElementById(scope.preBtn))
    })() : (function() {
      return;
    })();
    !!scope.nextBtn ? (function() {
      $nextBtn = angular.element(document.getElementById(scope.nextBtn))
    })() : (function() {
      return;
    })();
    !!scope.triggersElement ? (function() {
      $triggersElement = angular.element(document.getElementById(scope.triggersElement))
    })() : (function() {
      return;
    })();
